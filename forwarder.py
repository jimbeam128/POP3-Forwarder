...
# Prüfen, ob POP3 Connection gültig und Login erfolgreich
if not pop_conn:
    had_fatal_error = True
    print("[FATAL] POP3 Verbindung konnte nicht hergestellt werden.")
elif hasattr(pop_conn, "welcome") and pop_conn.welcome.startswith(b'-ERR'):
    had_fatal_error = True
    print(f"[FATAL] POP3 Login fehlgeschlagen: {pop_conn.welcome.decode(errors='replace')}")
    pop_conn = None

# ======================
# UIDLs abrufen & Weiterleitung
# ======================
